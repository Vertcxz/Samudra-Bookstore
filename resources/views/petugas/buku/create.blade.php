                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" wire:model="penerbit_id" value="" id="penerbit0">
                                        <label class="form-check-label" for="penerbit0">
                                            Pilih Penerbit
                                        </label>
                                    </div>
                                    @foreach ($penerbit as $item)
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" wire:model="penerbit_id" value="{{$item->id}}" id="penerbit{{$item->id}}">
                                            <label class="form-check-label" for="penerbit{{$item->id}}">
                                                {{$item->nama}}
                                            </label>
                                        </div>
                                    @endforeach
